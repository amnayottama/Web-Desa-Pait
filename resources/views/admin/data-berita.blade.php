        ...
        <div class="flex flex-col justify-between">
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-4">
                            ...
                            <input class="hidden" id="small_size" type="file">
            ...
            <div class="relative mt-4 p-4 overflow-x-auto shadow-md rounded-lg bg-white sm:rounded-lg">
                ...
                <table id="myTable" class="display w-full text-sm text-left rtl:text-right">
                    ...
                    <div class="dt-search"><label for="dt-search-0">Search:</label><input type="search" class="dt-input" id="dt-search-0" placeholder="" aria-controls="myTable"></div>
            ...
            <div id="edit-modal" data-modal-backdrop="edit" tabindex="-1" aria-hidden="true"
                class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    <!-- Modal edit content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-4">
                            ...
                            <div class="my-2">
                                <input type="judul2" id="judul2"
                                    class=" border border-gray-300 text-gray-500 text-xs rounded-md focus:ring-blue-500 focus:border-blue-500 w-full p-2"
                                    required />
                            </div>
                            <label for="editor2" class="text-sm text-gray-500  ">Berita</label>
                            <textarea rows="10" name="content" id="editor2"></textarea>
                            <label class="block py-2 text-sm text-gray-500" for="small_size">Gambar</label>
                            <button id="uploadButton2"
                                class="bg-white border-gray-300 text-[#101E9E] border rounded-sm w-full py-6 mb-2">Browse</button>
                            <input class="hidden" id="small_size2" type="file">
    ...
    @push('scripts')
        ...
        <script>
            ...
            uploadButton.addEventListener('click', function() {
                fileInput.click(); // Aktifkan input file ketika tombol diklik
            });
            // Tambahkan event listener untuk input file
            fileInput.addEventListener('change', function() {
                const file = fileInput.files[0]; // Ambil file yang diunggah
                if (file) {
                    fileNameDisplay.textContent = `File terpilih: ${file.name}`; // Tampilkan nama file
                } else {
        ...
        <script>
            ...
            uploadButton2.addEventListener('click', function() {
                fileInput2.click(); // Aktifkan input file ketika tombol diklik
            });
            // Tambahkan event listener untuk input file
