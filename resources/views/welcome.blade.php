...
@section('content')
    <section class="relative bg-center bg-no-repeat bg-cover bg-gray-700 bg-blend-screen"
        ...
        <div class="relative z-10 px-6 md:px-16 mx-auto w-full text-left py-24 lg:py-56">
            <h1
            ...
            <p class="mb-8 text-sm font-normal text-gray-300 md:text-md lg:text-xl">Desa Pait Merupakan Desa yang Terletak di
                Kecamatan
                <br> Kesambon, Kabupaten Malang, Provinsi Jawa Timur
            </p>
            <div class="flex space-y-4 sm:flex-row sm:justify-start sm:space-y-0">
                <a href="{{ route('login') }}"
                    class="inline-flex justify-center items-center pt-2 pb-3 px-5 text-base font-medium text-center text-white rounded-full bg-red-600 shadow-md shadow-red-600 hover:bg-red-700">
